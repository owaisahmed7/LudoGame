...
function rollDice(player) {
  ...
  if (player === 1) {
    total1 += diceNumber;
    document.getElementById(scoreBoxId).innerText = `Player 1 total score is: ${total1}`;
  } else {
    total2 += diceNumber;
    document.getElementById(scoreBoxId).innerText = `Player 2 total score is: ${total2}`;
  }
